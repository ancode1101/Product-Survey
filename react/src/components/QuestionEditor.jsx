        ...
        <div>
            <div className="flex justify-between mb-3">
                ...
                <div className="flex items-center">
                    <button
                        type="button"
                        className="flex item-center text-xs py-1 px-3 mr-2 rounded-sm text-white bg-gray-600 hover:bg-gray-700"
                    ...
                    <button
                        type="button"
                        className="flex item-center py-1 px-3 rounded-sm border border-transparent text-red-500 hover:bg-gray-600 font-semibold"
                    ...
                    <div>
                        <h4 className="text-sm font-semibold mb-1 flex justify-between items-center ">
                            ...
                            <button
                                onClick={addOption} 
                                type="button" 
                                className="items_center text-xs py-1 px-2 rounded-sm text-white bg-gray-600 hover:bg-gray-700">
                                Add
                            </button>
                        </h4>
                            ...
                            <div>
                                {model.data.options.map((op, ind) => (
                                    <div key={op.uuid} className="flex items-center mb-1">
                                        <span className="w-6 texts-center mb-1">{ind + 1}</span>
                                        <input 
                                            type="text" 
                                            value={op.text || ''} 
