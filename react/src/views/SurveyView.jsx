            ...
            {!loading && <form  action="#" method="POST" onSubmit={onSubmit}>
                <div className=" shadow sm:overflow-hidden sm:rounded-md">
                    ...
                    <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                        ...
                        {/*Image*/}
                        <div>
                            <label className="black text-sm font-mediam text-gray-700">
                                Photo
                            </label>
                            <div className="mt-1 flex item- center">
                                ...
                                {!survey.image_url && (
                                    <span className="flex justify-center items-center text-gray-400 h-10 w-10
                            overflow-hidden rounded-full bg-gray-100">
                                ...
                                <button
                                    type="button"
                                    className=" relative ml-5 rounded-md border-gray-300 bg-white py-0 px-3 text-sm
                            font-mediam leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none
                            focus:ring-2 focus:ring-indigo-500 foucus:ring-offset-2"
                                >
                                    <input
                                        type="file"
                                        className="absolute left-0 top-3 right-0 opacity-0"
                        ...
                        <div className="col-span-6 sm:col-span-3">
                            <label
                                htmlFor="title"
                                className="black text-sm font-mediam text-gray-700"
                            >
                                Survey Title
                            </label>
                            <input
                        ...
                        <div className=" col-span-6 sm:col-span-3">
                            <label
                                htmlFor="description"
                                className="black text-sm font-mediam text-gary-700"
                            >
                                Description
                            </label>
                            <textarea
