    ...
    <PageComponent title="Dashboard">
      ...
      {!loading && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700">
          ...
          >
            <div className="text-8x1 pd-4 font-semibold flex-1 flex items-center justify-center">
              {data.totalSurveys}
            </div>
          </DashboardCard>
          <DashboardCard
          ...
          >
            {data.latestSurvey && (
              <div>
                ...
                />
                <h3 className="font-bold text-x1 md-3">
                  {data.latestSurvey.title}
                </h3>
                <div className="flex justify-between text-sm md-1">
                  <div>Create Date:</div>
